            ...
            <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted text-sm "></p>
                                    <a href="{{ Auth::user()->getGuard() == 'client' ? '#' : route('tasks.index', $currentWorkspace->slug) }}">
                        ...
                        <div class="col-xl-3 col-md-6 col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted text-sm"></p>
                                    <a href="{{Auth::user()->getGuard() == 'client' ? '#' : route('users.index', $currentWorkspace->slug) }}">
                                        ...
                                        @foreach ($tasks as $task)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($task->complete == '1')
                                                        <span
                                                            class="status_badge_dash badge bg-success p-2 px-3">{{ __($task->status) }}</span>
                                                    @else
                                                        <span
                                                            class="status_badge_dash badge bg-primary p-2 px-3">{{ __($task->status) }}</span>
                                                    @endif
                                                </td>
                                                <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="font-14 mt-1 font-weight-normal">
                                                            @foreach ($task->taskUsers() as $user)
                                                                <span
                                                                    class="badge p-2 px-2 bg-secondary">{{ isset($tasksUsers[$user]) ? $tasksUsers[$user] : '-' }}</span>
                                                            @endforeach
                                                        </div>
                                                    </td>
                                                @endif
                ...
                <div class="col-lg-5 col-md-5 ">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="float-end">
                                <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Refferals">
                                    <i class=""></i>
                                </a>
                            </div>
                                ...
                                <div class="col-sm-6  pb-5 px-3">
                                    <div class="col-12 col-sm-10">
                                        <span class="d-flex justify-content-center align-items-center mb-2">
                                            <i class="f-10 lh-1 fas fa-circle" style="color:rgb(237, 241, 4);"></i>
                                            <span class="ms-2 text-sm">On Going</span>
                                        </span>
                                    </div>
                                    <div class="col-12 col-sm-10">
                                        <span class="d-flex justify-content-center align-items-center mb-2">
                                            <i class="f-10 lh-1 fas fa-circle" style="color: rgb(233, 47, 47);"></i>
                                            <span class="ms-2 text-sm">On Hold</span>
                                        </span>
                                    </div>
                                    <div class="col-12 col-sm-10">
                                        <span class="d-flex justify-content-center align-items-center mb-2">
                                            <i class="f-10 lh-1 fas fa-circle" style="color: rgb(113, 159, 234);"></i>
