...
@section('content')
    <div class="row row-gap-2 mb-4">
        ...
        <div class="row align-items-center display-none" id="show_filter">
            ...
            <div class="col-sm-6 col-xl-2 m-0">
                <input type="text" class="form-control" name="company_name" placeholder="{{ __('Company') }}">
            </div>
            <div class="col-sm-6 col-xl-2 m-0">
                <input type="email" class="form-control" name="email" placeholder="{{ __('Email') }}">
            </div>
            <div class="col-sm-6 col-xl-2 m-0">
                <input type="tel" class="form-control" name="phone" placeholder="{{ __('Phone') }}">
            </div>
            <div class="col-sm-6 col-xl-2 m-0">
                <button class="btn btn-primary btn-sm btn-filter me-1"
                        title="{{ __('Apply') }}">
                    <i class="ti ti-search"></i>
                </button>
                <button class="btn btn-sm btn-danger btn-reset"
                        title="{{ __('Reset') }}">
        ...
        <div class="modal fade" id="followupModal" tabindex="-1" aria-labelledby="followupModalLabel"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form id="followupForm" action="{{ route('opportunities.store', $currentWorkspace) }}"
                          method="POST">
                        @csrf
                    ...
                    <form id="editForm" method="post" action="{{route('opportunities.update',$currentWorkspace)}}">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">{{ __('Company') }}</label>
                                    <input name="company_name" type="text" class="form-control" id="editCompany"
                                           required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">{{ __('Email') }}</label>
    ...
    <div class="card">
        ...
        @push('css-page')
            ...
            <link rel="stylesheet"
                  href="{{ asset('assets/custom/libs/bootstrap-daterangepicker/daterangepicker.css') }}">
        @endpush
        @push('scripts')
            ...
            <script>
                $(document).ready(function () {
                    var table = $('#opportunities-table').DataTable({
                        ...
                        serverSide: true,
                        ajax: {
                            url: "{{ route('opportunities.datatable', $currentWorkspace) }}",
                            data: function (d) {
                    ...
                    $('.btn-secondary[href="{{ route('opportunities.index', $currentWorkspace) }}"]').on('click', function (e) {
                        e.preventDefault();
                    ...
                    $('.btn-reset').click(function() {
                        $('#show_filter input').val('');
                        $('#show_filter select').val('');
                        table.ajax.reload();
                    });
