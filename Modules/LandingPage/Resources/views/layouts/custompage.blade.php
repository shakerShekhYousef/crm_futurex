...
<head>
    ...
    <!-- font css -->
    <link rel="stylesheet" href=" {{ asset('landing_page_assets/fonts/tabler-icons.min.css') }}" />
    <link rel="stylesheet" href=" {{ asset('landing_page_assets/fonts/feather.css') }}" />
    <link rel="stylesheet" href="  {{ asset('landing_page_assets/fonts/fontawesome.css') }}" />
    <link rel="stylesheet" href="{{ asset('landing_page_assets/fonts/material.css') }}" />
    ...
    @else
        <link rel="stylesheet" href="{{ asset('landing_page_assets/css/style.css') }}" id="main-style-link">
    @endif

    <!-- vendor css -->
    {{-- <link rel="stylesheet" href="  {{ asset('landing_page_assets/css/style.css')}}" /> --}}
    <link rel="stylesheet" href=" {{ asset('landing_page_assets/css/customizer.css') }}" />
    <link rel="stylesheet" href=" {{ asset('landing_page_assets/css/landing-page.css') }}" />
...
<script src="{{ asset('landing_page_assets/js/plugins/popper.min.js') }}"></script>
<script src="{{ asset('landing_page_assets/js/plugins/bootstrap.min.js') }}"></script>
<script src="{{ asset('landing_page_assets/js/plugins/feather.min.js') }}"></script>
