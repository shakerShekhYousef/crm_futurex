                                                        ...
                                                        <span>
                                                            <div class="action-btn me-1">
                                                                <a href="#" class="btn btn-sm btn-info"
                                                                    ...
                                                                    data-title="{{ __('Update Feature ') }}" data-size="lg"
                                                            ...
                                                            <div class="action-btn">
                                                                ...
                                                                <a href="#" class="btn btn-sm btn-danger bs-pass-para"
                                                                    ...
                                                                    data-text="{{ __('This action can not be undone. Do you want to continue?') }}"                                                                    data-confirm-yes="{{ 'delete-form-' . $key }}">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a data-size="lg" data-url="{{ route('features_create') }}" data-ajax-popup="true"
                                        ...
                                        class="btn btn-sm btn-primary" title="{{ __('Create') }}">
                                        <i class="ti ti-plus text-light"></i>
                                    </a>
                                </div>
                            </div>
                                                    ...
                                                    <td>
                                                        <div class="action-btn me-1">
                                                            <a href="#" class="btn btn-sm btn-info"
                                                                ...
                                                                data-ajax-popup="true"
                                                                data-title="{{ __('Update Feature Block') }}"
